...
<head>
  ...
  <style>
    body {
      ...
      align-items: center;
      background-image: url('./images/mod4.png'); /* Add your image path here */
...
<body>
  ...
  <div class="content-box mt-2" style="top:40%">
      <h4>Degree of Competitiveness</h4>
    </div>
    <div class="content-box mt-2" style="top:50% ">
      <h4>3D Efficiency orgnizational operation</h4>
    </div>
    <div class="content-box mt-2" style="top:60%">
      <h4>Team Dynamic in my view</h4>
    </div>
    <div class="content-box mt-2 " style="top:70%">
      <h4>Personal State-of-mind vs future</h4>
    </div>
    <div class="content-box mt-2" style="top:80%">
      <h4>Realignment PLAN</h4>
    </div>
  </div>
