...
<head>
  ...
  <style>
    body {
      ...
      align-items: center;
      background-image: url('./images/mod2.png'); /* Add your image path here */
...
<body>
  ...
  <div class="content-box mt-2" style="top:20%">
    ...
    <div class="content-box mt-2" style="top:30% ">
      <h4>Simple project CHARTERS</h4>
    </div>
    <div class="content-box mt-2" style="top:40%">
      <h4>GANTT chart & Timelines</h4>
    </div>
    <div class="content-box mt-2 " style="top:50%">
      <h4>Clear responsibilities & Deliverables</h4>
    </div>
    <div class="content-box mt-2" style="top:60%">
      <h4>Dynamic collaboration</h4>
    </div>
    <div class="content-box mt-2" style="top:70%">
      <h4>DASHBOARD for critical Projects</h4>
    </div>
  </div>
